    ...
    public Attractions crawlerPlaceData(String place,String keyword ){
        ...
        try {
            ...
            //for (Element li : lis) {
                ...
                // 提取電話
                try{
                    telephone = doc.getElementsContainingOwnText("電　　話").get(0).text().substring(5);
                }catch (Exception e){
                    telephone = "查無電話";
                }
                ...
                // 提取地址
                try{
                    address = doc.getElementsContainingOwnText("地　　址").get(0).text().substring(5);
                }catch (Exception e){
                    address = "查無地址";
                }
                ...
                // 提取營業時間
                try{
                    openTime = doc.getElementsContainingOwnText("營業時間：").get(0).text().substring(5);
                }catch (Exception e){
                    openTime = "查無地址";
                }
